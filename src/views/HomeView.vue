<template>
      ...
      <div class="row">
        <div class="col-12 col-md-8 offset-md-2">
          <h1 class="text-center">
            <img
              src="/Users/yskong/Desktop/FIT5032/lab02/src/databaseicon/databaseIcon.png"
              alt="Icon"
              class="icon"
            />
            Home Page
          </h1>
          <h6 class="text-center mb-4">Let's build some more advanced features into our form.</h6>
  ...
  .icon {
    ...
    vertical-align: baseline; /* Align icon with the text */
  }
  </style>
